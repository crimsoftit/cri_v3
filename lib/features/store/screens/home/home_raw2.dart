...
import 'package:cri_v3/features/store/screens/home/widgets/fresh_user_screen.dart';
      ...
      () {
        WidgetsBinding.instance.addPostFrameCallback(
          (_) async {
            ...
            await txnsController.fetchSoldItems().then((_) async {
                ...
                child: Obx(() {
                  ...
                  return Column(
                    ...
                    children: [
                      ...
                      if (txnsController.sales.isEmpty &&
                          !txnsController.isLoading.value)
                        CFreshUserScreen(isDarkTheme: isDarkTheme),
